...
python3 f.py f.lst SRC_FORMAT=\"nn\" TIMEFRAME=15 TRAIN_VS_TEST=None NUM_CLASSES=None TICKER=\"btcusd\" THRESHOLD_PCT=0.7 PREDICTION_THRESHOLD=1.25 >> f.txt
python3 f.py f.lst SRC_FORMAT=\"nn\" TIMEFRAME=15 TRAIN_VS_TEST=None NUM_CLASSES=3 TICKER=\"btcusd\" THRESHOLD_PCT=0.7 PREDICTION_THRESHOLD=1.25 >> f.txt
python3 f.py f.lst SRC_FORMAT=\"nn\" TIMEFRAME=15 TRAIN_VS_TEST=None NUM_CLASSES=5 TICKER=\"btcusd\" THRESHOLD_PCT=0.7 PREDICTION_THRESHOLD=1.25 >> f.txt
