...
train = rutils.load_and_prepare_data(src, TICKER, TIMEFRAME, lookahead_candles=LOOK_AHEAD, 
	class_threshold=CLASS_THRESHOLD, num_classes=NUM_CLASSES)
if train is None:
	sys.stderr.write('Failed to load or prepare train data. Exiting...\n')
	sys.exit(0)

test = rutils.load_and_prepare_data(src, TICKER, TIMEFRAME, lookahead_candles=LOOK_AHEAD, 
